...
public class PlatoABM {
    ...
    public void modificarPrecio(long idPlato, double nuevoPrecio) throws Exception {
    ...
    public List<Plato> traerPrecioMayorA(double precio) throws Exception {
        List<Plato> lista = dao.traerPrecioMayorA(precio);
        if (lista == null || lista.isEmpty()) {
            throw new Exception("ERROR: No se encontraron platos con precio mayor a $" + precio);
        }
        return lista;
    }
}